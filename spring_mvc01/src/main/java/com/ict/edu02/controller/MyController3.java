...
public class MyController3 {
	...
	// 서비스와 같이 다른곳에서 만들어진 객체를 가져와서 사용하기 위한 어노테이션
	// @Inject :java
	// @Autowired :Spring
	...
	/* @PostMapping("/calc2")
	   public ModelAndView calc2Exec(CalcVO cvo) { // CalcVO에 파라미터들이 알아서 넣어진다.(변수와 파라미터 이름이 같아야 한다.)
	...
	*/
	...
	@PostMapping("/calc2")
	public ModelAndView calc2Exec(@ModelAttribute("cvo")CalcVO cvo) { // CalcVO에 파라미터들이 알아서 넣어진다.(변수와 파라미터 이름이 같아야 한다.)
		ModelAndView mv = new ModelAndView("day02/result");
