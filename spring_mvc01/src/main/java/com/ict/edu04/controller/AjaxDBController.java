...
@RestController //ajax는 무조건 @RestController
public class AjaxDBController {
	
	@Autowired // 다른 클래스를 써야 되면 Autowired 한다.
	...
	public String getAjaxList2() {
		//Spring에서 json을 만들거나 파싱할때는 여러가지 라이브러리를 사용할수 있다.
	...
	@ResponseBody
	public String getAjaxMemberDelete(String m_idx) {
