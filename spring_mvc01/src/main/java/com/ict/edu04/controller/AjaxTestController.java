...
public class AjaxTestController {
	...
	public String Xml_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=" + "il+P/e7zwgt5xbUVTVBuc9xY8+73g6ITvfkzLSrJXzT1djt91odCpi8F64hsVdG5UPE5UlqP/POY+I9RuSdnOQ==");   /*자기의 서비스키 = Service Key*/
	...
	public String Json_Exam07() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=il%2BP%2Fe7zwgt5xbUVTVBuc9xY8%2B73g6ITvfkzLSrJXzT1djt91odCpi8F64hsVdG5UPE5UlqP%2FPOY%2BI9RuSdnOQ%3D%3D"); /*Service Key*/
	        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
	        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
