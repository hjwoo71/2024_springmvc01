...
<body>
	...
	<script type="text/javascript">
		...
		function toggleJoinButton() {
			const passwordFild = $("#m_pw").val() !=="";
			const nameFild = $("#m_name").val() !=="";
			const ageFild = $("#m_age").val() !=="" && parseInt($("#m_age").val()) > 0;
			
			if(isInputChk && passwordFild && nameFild && ageFild){
		...
		// 파라미터(하나일때 사용) => data : "m_id=" +$("m_id").bal()
		...
		$("#list").on("click", "#member_del", function(){
			...
			$.ajax({
				...
				data : "m_idx=" + $(this).attr("name"),  //파라미터(한개일때 사용)
				method : "post",
				dataType : "text",
				success : function(data) {
					if(data =='0'){
