...
<body>
	...
	<h3><a href="/member_list">Members 전제 보기</a></h3>
	<hr>
	<!-- 이미지는 무조건 webapp-resources 안에 넣어 주세요 -->
	<h2>이미지 보기</h2>
	...
	<h2><a href="/ajax_test_xml">Ajax XML 연습하는 장소이동</a></h2>
	<h2><a href="/ajax_test_json">Ajax JSON 연습하는 장소이동</a></h2>
	<h2><a href="/ajax_test_DB">Ajax DB 연습하는 장소이동</a></h2>
	<h2><a href="/emp">동적 query 연습 장소이동</a></h2>
	<h2><a href="/email">이메일 연습 장소이동</a></h2>
