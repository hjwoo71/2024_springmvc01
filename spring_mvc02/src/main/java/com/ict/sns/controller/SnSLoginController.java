...
public class SnSLoginController {
	...
	public ModelAndView kakaologin( HttpServletRequest request) {
		...
		try {
			  ...
			  sb.append("&client_id=d6088e3d9ffeb3d60a2bb45793e040d9");
			  sb.append("&redirect_uri=http://localhost:8080/kakaologin");
			  sb.append("&code="+code);
			  sb.append("&client_secret=xPC5ifWqimwhVdHdQyEQWCKQ9jbHKTl2");
	...
	public ModelAndView naverlogin( HttpServletRequest request) {
		...
		try {
			  ...
			  StringBuffer sb = new StringBuffer();
			  sb.append("grant_type=authorization_code");
			  sb.append("&client_id=p29W8MboRPSp6ZgZoa6L");
			  sb.append("&client_secret=9H7aaHq9zv");
			  sb.append("&code="+code);
    ...
    public ModelAndView maverlogout(HttpServletRequest request) {
    ...
    public ModelAndView daumAddrOK(AddrVO addrvo , HttpSession session) {
		...
		// 로그인 성공한 상태에서 session 안에 있는 사용자 정보 중 m_id 나 사용자테이블의 pk를 호출 한다.
