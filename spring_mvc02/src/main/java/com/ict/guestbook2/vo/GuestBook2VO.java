...
public class GuestBook2VO {
	//DB 컬럼과 같아야 한다.
	private String gb2_idx , gb2_name , gb2_subject , gb2_content , gb2_email , gb2_pw , gb2_regdate , gb2_file_name , old_f_name;
	...
	// 파라미터와 같아야 한다.
	private MultipartFile gb2_f_name ;
	
	
	public String getGb2_file_name() {
		return gb2_file_name;
	}

	public void setGb2_file_name(String gb2_file_name) {
		this.gb2_file_name = gb2_file_name;
	}

	public MultipartFile getGb2_f_name() {
		return gb2_f_name;
	}

	public void setGb2_f_name(MultipartFile gb2_f_name) {
