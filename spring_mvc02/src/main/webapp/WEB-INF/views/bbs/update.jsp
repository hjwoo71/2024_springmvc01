	...
	<form method="post" encType="multipart/form-data" action="/bbs_update_ok">
		<table summary="게시판 수정">
			...
			<tbody>
				<tr>
					<th>제목:</th>
					<td><input type="text" name="subject" size="70" value="${bvo.subject}"></td>
				</tr>
				<tr>
					<th>이름:</th>
				...
				<tr>
					<th>내용:</th>
					<td><textarea name="content" id="content" cols="50" rows="8" value="${bvo.content}"></textarea></td>
				</tr>
				<tr>
					<th>첨부파일:</th>
					<c:choose>
						<c:when test="${empty bvo.f_name}">
							<td>
								<input type="file" name="file_name" ><b>이전파일 없음</b>
								<input type="hidden" name = "old_f_name" value = "">
							</td>
						</c:when>
						<c:otherwise>
							<td>
								<input type="file" name="file_name" ><b>이전파일 있음<br>(${bvo.f_name})</b>
