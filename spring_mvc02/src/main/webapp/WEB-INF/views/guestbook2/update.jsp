				...
				<tr align="center">
					...
					<c:choose>
						<c:when test="${empty gb2vo.gb2_file_name}" >
							<td>
							   <input type="file" name="gb2_f_name"><b>이전 파일 없음 </b>
							   <input type="hidden" name="old_gb2_file_name" value="">
							</td>
						</c:when>
						<c:otherwise>
							<td>
								<input type="file" name="gb2_f_name"><b>이전 파일 ${gb2vo.gb2_file_name} </b>
								<input type="hidden" name="old_gb2_file_name" value="${gb2vo.gb2_file_name}">
							</td>
						</c:otherwise>
					</c:choose>
				</tr>
